 ...
 * <code>pom.xml</code> and runs the tests inside of them. By default there are
 * two:
 * <ul>
...
public class IntegrationTest {
    ...
    public void testUIModelUI() {
        RegexTesting model = new RegexTesting("f.o,bar,hello,world", ",", "_", new GeneratedCodeConfig(
